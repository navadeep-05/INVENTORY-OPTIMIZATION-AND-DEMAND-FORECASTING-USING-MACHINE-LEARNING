...
def show_about():
    ...
    """)
    st.write("")
    st.image(r"animation-of-brainstorming-idea-business.mp4", caption='Empowering Growth Through Data-Driven Insights and Forecasting', width=700, clamp=True, channels='RGB')
